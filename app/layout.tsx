...
export const metadata: Metadata = { title: { default: 'LeckerSchmeck | Recipes you can actually follow', template: '%s · LeckerSchmeck' }, description: 'Turn any public recipe into a clear, visual cooking workflow. Scale, convert, edit, cook and share without the clutter.', icons: { icon: '/favicon.svg', shortcut: '/favicon.svg', apple: '/favicon.svg' } };
